...
//        echo $moins1An;
  ...
  public function voirDetailFrais($mois){
      ...
      $lesFraisHorsForfait = $gsbFrais->Aff_Detail_HorsForfait($idVisiteur, $mois);
      $lesFraisHorsForfaitSup = $gsbFrais->Aff_Detail_HorsForfaitSup($idVisiteur, $mois);
      $montantTotal = 0;
      ...
      $erreur = "";
      return view('listeDetailFiche', compact('lesFraisForfait', 'lesFraisHorsForfait', 'lesFraisHorsForfaitSup', 'mois', 'erreur', 'titreVue','montantTotal'));
  }
}
